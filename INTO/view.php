<?php
  ...
  //pre_r($result);
  ?>
  <table id="customers" bgcolor="silver" style="margin-top: 70px; font-size: 19.5px; border-style: ridge;" border="5" >
      <thead>
        <tr>
          <th>Firstname</th>
          <th>Surname</th>
...
<div id="myDIV" class="header">
  <h2 style="margin:5px"><font color="red">Clients Attended</font> & To Attend to</h2>
  <input type="text" id="myInput" placeholder="Title...">
  <span onclick="newElement()" class="addBtn">Add</span>
</div>

<ul id="myUL">
  <li class="checked">David</li>
  <li>Denis </li>
  <li>Denis</li>
  <li>Whitney</li>
</ul>
